...
public class ApplyImpl implements ApplyIntf {
	...
	public List<ModelDataAttribute> queryApplyById4ModelDataAttribute(String applyId) {
		...
		List<ApplyAttribute> applyAttributes = commonDaoIntf.selectObjListByParam(ApplyAttribute.class, "brmp_apply_attribute", paramMap);
		...
		List<ModelData> modelDatas = commonDaoIntf.selectObjByParamlist(ModelData.class, "brmp_conf_origin_system_modelbase", paramMap);
		...
		List<ModelDataAttribute> modelDataAttributesTemp = commonDaoIntf.selectObjByParamlist(ModelDataAttribute.class, "brmp_conf_origin_system_model", paramMap);
	...
	public List<List<ModelDataAttribute>> queryApplyById4ApplyDataAttribute(String applyId) {
		...
		for (int i=0;i<modelDatas.size();i++){
			...
			List<ModelDataAttribute> modelDataAttributesTemp = commonDaoIntf.selectObjListByParam(ModelDataAttribute.class, "brmp_conf_origin_system_model", paramMap);
			//List<ModelDataAttribute> modelDataAttributesTemp = commonDaoIntf.selectObjByParamlist(ModelDataAttribute.class, "brmp_conf_origin_system_model", paramMap);
			List<ModelDataAttribute> modelDataAttributes = new ArrayList<ModelDataAttribute>();
