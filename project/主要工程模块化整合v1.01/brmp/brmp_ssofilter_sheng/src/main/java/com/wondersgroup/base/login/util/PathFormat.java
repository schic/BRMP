...
import com.wondersgroup.core.utils.DateUtils;
...
public class PathFormat {
	...
	private static String getFullYear() {
		return DateUtils.Format("yyyy", currentDate);
	}

	private static String getYear() {
		return DateUtils.Format("yy", currentDate);
	}

	private static String getMonth() {
		return DateUtils.Format("MM", currentDate);
	}

	private static String getDay() {
		return DateUtils.Format("dd", currentDate);
	}

	private static String getHour() {
		return DateUtils.Format("HH", currentDate);
	}
	...
	private static String getSecond() {
		return DateUtils.Format("ss", currentDate);
	}
