...
public interface CommonDaoIntf {
	...
	<T> int batchPreparedStatementSetter(List<T> list, String tableName);
	 ...
	 * @param <T>
	 */
	<T> Object selectObjByParam(Class<T> clazz, String tableName, Map<String, Object> paramMap);
	 ...
	 * @return
	 */
	<T> List<T> selectObjListByParam(Class<T> clazz, String tableName, Map<String, Object> paramMap);
	 ...
	 * 
	 */
	<T> List<T> selectObjByParamlist(Class<T> clazz, String tableName, Map<String, Object> paramMap);
