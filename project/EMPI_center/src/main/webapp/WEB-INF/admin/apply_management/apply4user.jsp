...
<div id="contact" class="text-center">
	...
	<table id="apply" class="easyui-datagrid" title="资源申请管理,用户申请的资源,用户查看审核状态,并完成api调用" style="width:100%;height:450px"
...
<div id="getApi" class="easyui-dialog" title="调用的api"  closed="true" data-options="iconCls:'icon-help',modal:'false',onClose:afterCancelApi,toolbar:'#transmission_test_toolbar',buttons:'#transmission_test_button'" style="width:80%;height:80%;padding:10px">
	...
	<div style="width:100%">
		...
		<textarea style="width:100%" name="test_params" id="test_params" class="form-control" rows="10" placeholder="传参样例" readonly="true"></textarea>
	</div>
	<p></p>
