...
-- ----------------------------
INSERT INTO `brmp_conf_origin_system_modelbase` VALUES ('testA001', 'test123456789', 'TestModel1', 'MODELTEST1', '2019-11-19 09:59:46', '2019-12-02 17:57:09', '这个是测试模型1', 0, 9);
INSERT INTO `brmp_conf_origin_system_modelbase` VALUES ('test002', 'test002ABCDEF', 'Tes2Model2', 'MODELTEST2', '2019-11-19 09:59:46', '2019-12-06 12:42:59', '这个是测试模型2', 0, 9);
...
INSERT INTO `brmp_grxx` VALUES ('deec237a6bdd350d8a2fd60f4f746d1a', '4745752f1d0e4682ab1a7ba167903cb4', '521311197611264522', '测试人员3', '1', '1976-11-26', '18055556666', '绵阳', '赵XX', '1234567', 51, '2020-03-24 15:42:20');
INSERT INTO `brmp_grxx` VALUES ('1cd41c49716d3178aca8aaa498cb2a91', 'caa016fb60f04816a4a932bc37c76f1d', '-', '-', '-', '1900-01-01', '-', '-', '-', '-', 25, '2020-03-24 15:42:20');
...
-- ----------------------------
INSERT INTO `brmp_grxx_cache` VALUES ('5c836699d5cb3d76a0db1312cf12250f', 'd48672e421114ecd9871bbf703959ec8', '521203198706302947', '测试人员1', '2', '1987-06-30', '13011112222', '四川', '王XX', '-', 'testA001', 'test001', 62, '2020-03-24 15:42:20');
INSERT INTO `brmp_grxx_cache` VALUES ('6f019a14a425326a9d010fa0ba7ef1f3', 'd48672e421114ecd9871bbf703959ec8', '521203198706302947', '测试人员1', '2', '1987-06-30', '-', '四川', '-', '-', 'testA001', 'test002', 62, '2020-03-24 15:42:20');
INSERT INTO `brmp_grxx_cache` VALUES ('804d819085e03e6a964ea1b9f2cd191e', '7abed33fc4c347ea8209f65ff10cd90e', '521211198807313945', '测试人员2', '1', '1988-07-31', '13133334444', '成都', '李XX', '9090980', 'testA001', 'test003', 75, '2020-03-24 15:42:20');
INSERT INTO `brmp_grxx_cache` VALUES ('d6847005512c34dbbd943441c1b879df', '7abed33fc4c347ea8209f65ff10cd90e', '521211198807313945', '测试人员2', '2', '1988-07-01', '13133334444', '成都', '-', '-', 'testA001', 'test004', 75, '2020-03-24 15:42:20');
INSERT INTO `brmp_grxx_cache` VALUES ('b05eb1d97b2139f7ba1d1c245867eb67', 'd48672e421114ecd9871bbf703959ec8', '521203198706302947', '测试错误姓名1', '2', '1987-06-30', '-', '自贡', '-', '-', 'testA001', 'test005', 51, '2020-03-24 15:42:20');
INSERT INTO `brmp_grxx_cache` VALUES ('deec237a6bdd350d8a2fd60f4f746d1a', '4745752f1d0e4682ab1a7ba167903cb4', '521311197611264522', '测试人员3', '1', '1976-11-26', '18055556666', '绵阳', '赵XX', '1234567', 'testA001', 'test006', 51, '2020-03-24 15:42:20');
INSERT INTO `brmp_grxx_cache` VALUES ('f5db176268ba32e7b94a52ef1786a533', 'd48672e421114ecd9871bbf703959ec8', '521203198706302947', '测试错误姓名1', '2', '1900-01-01', '-', '-', '-', '-', 'testA001', 'test007', 51, '2020-03-24 15:42:20');
INSERT INTO `brmp_grxx_cache` VALUES ('1cd41c49716d3178aca8aaa498cb2a91', 'caa016fb60f04816a4a932bc37c76f1d', '-', '-', '-', '1900-01-01', '-', '-', '-', '-', 'testA001', 'testNull', 25, '2020-03-24 15:42:20');
...
-- ----------------------------
INSERT INTO `md_9fb6518c3e1a439c8e49a16a56ba9791` VALUES (-1, 'af93e34c2d1', 'personId1', '2019-09-01 13:22:01', 9, 1, 0.5, 1, 0.50, '2019-12-04 02:04:05');
INSERT INTO `md_9fb6518c3e1a439c8e49a16a56ba9791` VALUES (-1, 'af93e34c2d2', 'personId2', '2019-09-02 14:23:09', 2, 2, 0.6, 2, 0.60, '2019-12-05 03:16:08');
...
CREATE TABLE `modeltest1_temp`  (
  `ZYBZ` int(1) NULL DEFAULT 0 COMMENT '作业标志,用于temp表',
  `testString23` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '测试字符串23',
  `testString1` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '测试字符串1',
  `testfloat1` float(7, 2) NULL DEFAULT NULL COMMENT '测试float1',
  `testDate1` datetime(0) NULL DEFAULT NULL COMMENT '测试Date1',
  `testInt1` int(2) NULL DEFAULT NULL COMMENT '测试int1'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `modeltest2_temp`  (
  `ZYBZ` int(1) NULL DEFAULT 0 COMMENT '作业标志,用于temp表',
  `test2String` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '测试2字符串',
  `test2String1` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '测试2字符串1',
  `test2Date1` datetime(0) NULL DEFAULT NULL COMMENT '测试2Date1',
  `test2Int1` int(2) NULL DEFAULT NULL COMMENT '测试2int1',
  `testinsert` float(5, 2) NULL DEFAULT NULL COMMENT '测试新增'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
