...
<body onload="init('${sessionScope.ssoUser.userType}')">
	...
	<%@ include file="../common/head.jsp" %>
  	...
  	<div class="easyui-layout" style="height:100%;width:100%";">
  		<div region="north" title="" style="background:url('static/common/img/intro-bg.jpg'); height:80px;">
	  	...
	  	<div id="center" region="center" title="" style="padding:2px; background:url('static/common/img/my_img/zzpic15320.jpg');" >
...
<!-- 数据申请弹出窗口 
-->
<div id="apply_data" class="easyui-dialog" title="数据申请"  closed="true" data-options="iconCls:'icon-man',modal:'false',onClose:afterCloseApplyData,buttons:'#table_apply_data'" style="width:80%;height:80%;padding:10px">
	<div style="width:55%;height:100%;float:left;">
		...
		<div id="2west" style="width:100%;height:100%;background-color:#D2E9FF;" hidden="true">
			<h2>基础资源申请</h2>
			...
			<div class="col-md-8 col-md-offset-2">
		      <form name="sentMessage" id="Form" action="apply_management/apply4system_form" method="post" enctype="application/x-www-form-urlencoded" novalidate>
		        ...
		        <div class="form-group">
		          ...
		          <textarea name="applyDirection" id="apply_direction" class="form-control" rows="4" placeholder="" ></textarea>
		          <p class="help-block text-danger"></p>
		        </div>
...
<!-- 多模型来源,申请多模型  -->
<div id="apply_data_more_model" class="easyui-dialog" title="多资源选择"  closed="true"  data-options="iconCls:'icon-man',modal:'false',onClose:afterCloseApplyDataMoreModel,buttons:'#table_apply_data_more_model' " style="width:500px;height:80%;padding:10px">
